...
<img src="./img/1.png" width="900" height="800">
<img src="./img/2.png" width="900" height="450">
<img src="./img/3.png" width="900" height="450">

  
- hasRole()과 hasAuthority()간의 차이점
  - hasRole은 ROLE_USER에서 **ROLE_** 접두어 없이 사용한다.
    - ex) `hasRole("USER");`
  - hasAuthority()는 ROLE_USER에서 **ROLE_** 접두어를 반드시 포함하여 사용한다.
    - ex) `hasAuthority("ROLE_USER")`


## 프로젝트 구성 - 선언적 방식

메모리 방식으로 사용자를 생성하고 권한을 할당한 후 테스트한다.
